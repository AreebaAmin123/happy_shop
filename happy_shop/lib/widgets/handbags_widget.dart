...
class HandbagsWidget extends StatefulWidget {
  final String categoryName;

  HandbagsWidget({required this.categoryName});

  @override
  _HandbagsWidgetState createState() => _HandbagsWidgetState();
}

class _HandbagsWidgetState extends State<HandbagsWidget> {
  late Future<List<Map<String, dynamic>>> handbags;

  @override
  void initState() {
    super.initState();
    handbags = fetchHandbagsData();
  }

  Future<List<Map<String, dynamic>>> fetchHandbagsData() async {
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('No handbags available.'));
          } else {
