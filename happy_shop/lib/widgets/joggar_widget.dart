...
class JoggersWidget extends StatefulWidget {
  final String categoryName;

  JoggersWidget({required this.categoryName});

  @override
  _JoggersWidgetState createState() => _JoggersWidgetState();
}

class _JoggersWidgetState extends State<JoggersWidget> {
  late Future<List<Map<String, dynamic>>> joggers;

  @override
  void initState() {
    super.initState();
    joggers = fetchJoggersData();
  }

  Future<List<Map<String, dynamic>>> fetchJoggersData() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder<List<Map<String, dynamic>>>(
        future: joggers, // Fetching the joggers data
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('No joggers available.'));
          } else {
            ...
            return Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'Available Joggers in ${widget.categoryName}',
