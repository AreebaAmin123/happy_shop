...
class WatchesWidget extends StatefulWidget {
  ...
  WatchesWidget({required this.categoryName});

  @override
  _WatchesWidgetState createState() => _WatchesWidgetState();
}

class _WatchesWidgetState extends State<WatchesWidget> {
  late Future<List<Map<String, dynamic>>> watches;

  @override
  void initState() {
    super.initState();
    watches = fetchWatchesData();
  }


  Future<List<Map<String, dynamic>>> fetchWatchesData() async {
            ...
            return Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'Available Watches in ${widget.categoryName}',
                    style: TextStyle(
                      fontSize: 22,
